...
struct AddMediaView: View {
    ...
    @State private var didApplyDefaultMediaType = false
    ...
    var body: some View {
        ...
        .onAppear {
            guard !didApplyDefaultMediaType else { return }
            mediaType = settings.first?.defaultMediaType ?? .movie
            didApplyDefaultMediaType = true
        }
    }
        ...
        HStack(spacing: 12) {
            ...
            VStack(alignment: .leading, spacing: 3) {
                ...
                HStack(spacing: 8) {
                    ...
                    if showPublic, let score = result.publicScore {
                        Text("Public: \(Formatters.publicScore(score))")
                            .font(.caption)
                            .foregroundStyle(KonomiTheme.inkSecondary.opacity(0.7))
                    }
                }
            }
            Spacer()
