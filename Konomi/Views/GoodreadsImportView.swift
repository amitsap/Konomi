...
struct GoodreadsImportView: View {
    ...
    private var shouldSuggestTasteProfile: Bool {
        ...
        let ratedCompletedCount = completedItems.filter { $0.personalScore != nil }.count
        return ratedCompletedCount >= TasteAnalysisService.minimumRatedItems && preview.importedRatingsCount > 0
    }
