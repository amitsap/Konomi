            ...
            HStack(spacing: 8) {
                ForEach(EmotionalResponse.allCases, id: \.self) { response in
                    ...
                    Button {
                        ...
                        .padding(.vertical, 7)
                        .background(isOn ? KonomiTheme.tasteViolet.opacity(0.15) : KonomiTheme.inkSecondary.opacity(0.1))
                        .foregroundStyle(isOn ? KonomiTheme.tasteViolet : KonomiTheme.ink)
                        .clipShape(Capsule())
                    }
                    .buttonStyle(.plain)
                }
        ...
        FlowLayout(spacing: 8) {
            ForEach(MoodTag.allCases, id: \.self) { tag in
                ...
                Button {
                    ...
                    .padding(.vertical, 6)
                    .background(isOn ? KonomiTheme.persimmon.opacity(0.15) : KonomiTheme.inkSecondary.opacity(0.1))
                    .foregroundStyle(isOn ? KonomiTheme.persimmon : KonomiTheme.ink)
                    .clipShape(Capsule())
                }
                .buttonStyle(.plain)
