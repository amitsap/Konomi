...
enum OpenLibraryService {
    ...
    static func makeSearchURL(query: String) throws -> URL {
        ...
        components.queryItems = [
            ...
            URLQueryItem(name: "fields", value: "key,title,author_name,first_publish_year,cover_i,number_of_pages_median,subject"),
            URLQueryItem(name: "limit", value: "20"),
        ]
        guard let url = components.url else { throw OLError.parseError }
        return url
    }
