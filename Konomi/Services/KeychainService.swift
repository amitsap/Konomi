...
enum KeychainService {
    nonisolated static let anthropicKey = "com.amiet.konomi.anthropic_key"
    nonisolated static let tmdbKey = "com.amiet.konomi.tmdb_key"
    nonisolated static let googleBooksKey = "com.amiet.konomi.google_books_key"
    ...
    nonisolated static func isUsableRequiredKey(_ value: String?) -> Bool {
        guard let value else { return false }
        return !value.trimmingCharacters(in: .whitespacesAndNewlines).isEmpty
    }

    nonisolated static func hasUsableAnthropicKey() -> Bool {
        isUsableRequiredKey(loadAnthropic())
    }

    nonisolated static func hasUsableTMDBKey() -> Bool {
        isUsableRequiredKey(loadTMDB())
    }
